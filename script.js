                ...
                if(e.target.classList.contains("flags")){
                    ...
                    countryInfo.forEach((country)=>{
                        ...
                        if(e.target["src"]==country.flags[1]){
                            card.innerHTML=
                            `<div class="info-card">
                                <img src="${country.flags[1]}" class="card-img-top" alt="flag">
                            </div>
                ...
                if(country.name.common==mySelect.value){
                    card.innerHTML=`
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><i class="fa-solid fa-landmark-flag"></i>${capital}</li>
                            <li class="list-group-item"><i class="fa-solid fa-language"></i> ${Object.values(languages)}</li>
                            <li class="list-group-item"><i class="fa-solid fa-money-bill-1-wave"></i>${Object.values(currencies)[0].name} ${Object.values(currencies)[0].name}</li>
                        </ul>`
                }
            })
            })
